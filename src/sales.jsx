...
export default function Sales(){
        ...
        <div className="sales-container">
            <div className="sales-box">
                <div className="s-box">
                    ...
                    <Link to="/FormulaBIElite"><button className="compare-btn">Check Plans</button></Link>
                    </div>
    ...
    <fieldset>
        ...
        />
           ...
           <legend>Organization Name <span className="note">(None, If not affiliated with any organization)</span><span className="req"> *</span></legend>
