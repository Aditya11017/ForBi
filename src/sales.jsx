        ...
        <section className="sales-form-panel">
          ...
          <form className="sales-form">
            ...
            <div className="full">
              ...
              <div className="pill-sal-row">
                {techOptions.map((t) => (
                  <button
                    type="button"
                    key={t}
                    className={`pill-sal ${selectedTech.includes(t) ? "pill-sal--active" : ""}`}
...
<div className="full">
            ...
            <div className="full">
              ...
              <div className="pill-row-sal">
                {budgetOptions.map((b) => (
                  <button
                    type="button"
                    key={b}
                    className={`pill-sal ${selectedBudget === b ? "pill-sal--active" : ""}`}
                    onClick={() => setBudget(b)}
