        ...
        <div className="train-container">
            <div className="train-box">
                <div className="t-box">
                    ...
                    <SignButton className="compare-btn" onClick={scrollClick}>Compare Plans</SignButton>
                    <br/>
                    ...
                    <div className="t-price-box">
                        ...
                        <div className="t-plan-box">
                            ...
                            <p>Designed for corporate and nonprofit teams, this training strengthens data literacy, science, and analytics capabilities using existing tools. We blends real-world examples with ethical practices and data security, fostering practical, collaborative, and future-ready learning.</p>
                        ...
                        <div className="t-plan-box">
                            ...
                            <p>Tailored training for educational institutions, in this training students are equipped with essential data literacy, science, and analytics skills, integrating seamlessly with your existing curriculum and infrastructure. We ensures students stay current in the evolving digital world while upholding ethical standards and data security.</p>
                            <form onSubmit={trainingSubmit}>
